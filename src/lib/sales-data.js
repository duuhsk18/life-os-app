...
export const LIFE_OS = {
  slug: 'life-os',
  emoji: '⚡',
  title: 'Life OS — O Sistema Completo de Gestão de Vida',
  subtitle: 'Hábitos, treinos, finanças, metas e journaling em um único sistema gamificado',
  price: 37.90,
  installment: { times: 3, value: 12.64 },
  monthlyAfter: 57.90,
  originalPrice: 97.00,
  description: 'Enquanto os materiais te dão o conteúdo, o Life OS te dá o sistema para colocar tudo em prática — com gamificação, streak, XP e acompanhamento em tempo real.',
  checkoutUrl: `${BASE_CHECKOUT}?off=lifeos-oto`,
  features: [
    'Tracker de hábitos diários com streak',
