...
export const PRODUCTS = {
  'receitas-low-carb': {
    ...
    // Benefícios positivos (4 pilares) — copiado da estrutura da concorrente validada
    benefits: [
      { icon: '⚖️', title: 'Emagrecimento real', desc: 'Sem efeito sanfona, sem dieta restritiva, sem sofrimento' },
      { icon: '⚡', title: 'Mais energia o dia inteiro', desc: 'Refeições equilibradas que tiram o sono da tarde' },
      { icon: '⏱️', title: 'Pronto em até 30 minutos', desc: 'Receitas práticas pra rotina corrida — nada de ficar 2h no fogão' },
      { icon: '✨', title: 'Saúde de dentro pra fora', desc: 'Pele, humor, intestino e disposição — tudo melhora junto' },
    ],
    ...
    whatYouGet: [
      { item: '80+ receitas low carb ilustradas (café, almoço, jantar)', value: 'R$47' },
      { item: 'Cardápio de 7 dias pronto pra imprimir e seguir', value: 'R$29' },
      { item: 'Lanches e sobremesas sem culpa (chocolate, doces, pão)', value: 'R$19' },
      { item: 'Lista de compras inteligente — semana resolvida em 1 ida ao mercado', value: 'R$17' },
      { item: 'Tabela de substituições (arroz→couve-flor, pão→psyllium…)', value: 'R$17' },
      { item: 'Guia de porções por objetivo (perder, manter, definir)', value: 'R$15' },
      { item: 'BÔNUS: Receitas de até 20 minutos pra dias caóticos', value: 'R$19' },
    ],
    testimonials: [
    ...
    faq: [
      { q: 'Preciso saber cozinhar?', a: 'Não. As receitas foram feitas pra quem nunca pegou numa panela. Cada uma tem o passo-a-passo ilustrado e leva no máximo 30 minutos.' },
      { q: 'Funciona pra quem nunca fez dieta?', a: 'Especialmente pra quem nunca fez. O guia tem cardápio pronto pros primeiros 7 dias — você só segue, sem precisar pensar.' },
      { q: 'Vou passar fome?', a: 'Não. Low carb feito direito reduz a fome porque a gordura boa e a proteína saciam por horas. Você come até ficar satisfeita.' },
      { q: 'Os ingredientes são caros ou difíceis de achar?', a: 'Tudo no mercado da esquina. A lista de compras inteligente otimiza pra você gastar menos do que gastava antes.' },
      { q: 'Como vou receber?', a: 'Imediato. Após o pagamento você recebe o link no email em até 2 minutos e baixa todos os PDFs — pra sempre, sem mensalidade.' },
      { q: 'Funciona pra quem tem diabetes ou pressão alta?', a: 'Low carb é frequentemente recomendado pra controle glicêmico e pressão. Mas sempre consulte seu médico antes de mudar a alimentação.' },
      { q: 'E se eu não gostar?', a: 'Garantia incondicional de 7 dias. Não gostou? Manda um email e devolvemos 100% do valor, sem pergunta nenhuma.' },
    ],
